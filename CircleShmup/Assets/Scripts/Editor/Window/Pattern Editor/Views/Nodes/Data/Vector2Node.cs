...
public class Vector2Node : BaseNode
{
     ...
     */
    public Vector2Node(int id, float x, float y) : this(id, new Rect(x, y, 150.0f, 100.0f), "Vector 2", NodeType.Vector2)
    {
        // None
    }
     ...
     */
    public Vector2Node(int id, Rect rect, string title, NodeType type) : base(id, rect, title, type)
    {
